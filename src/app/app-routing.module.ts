...
const routes: Routes = [
  ...
  {
    path: 'what-to-watch/streaming-services/netflix',
    component: NetflixComponent,
  },
  {
    path: 'what-to-watch/streaming-services/hbomax',
    component: HbomaxComponent,
  },
  { path: 'what-to-watch/streaming-services/hulu', component: HuluComponent },
  {
    path: 'what-to-watch/streaming-services/amazonprime',
    component: AmazonprimeComponent,
  },
  {
    path: 'what-to-watch/streaming-services/disneyplus',
    component: DisneyplusComponent,
  },
];
